...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0a0a0f] border-t border-[#1a1a25] py-12">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              {!logoError ? (
                ...
                <span className="font-mono text-lg text-[#666670]">R</span>
              )}
              <span className="font-mono text-base tracking-[0.15em] text-[#e8e8e8]">
                RAGNARÖK
              </span>
            </div>
            <p className="text-[#666670] text-sm max-w-md mb-6 leading-relaxed">
        ...
        <div className="pt-8 border-t border-[#1a1a25] flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="font-mono text-xs text-[#666670]">Built on</span>
            <SolanaLogo />
            <span className="font-mono text-xs text-[#666670]">Solana</span>
          </div>
        </div>
      </div>
    </footer>
